...
public final class UserColumns implements BaseColumns {
    ...
    public static final String API_FIELDS = "first_name, last_name, online, online_mobile, photo_50, " +
            "photo_100, photo_200, last_seen, platform, status, photo_max_orig, online_app, sex, domain, is_friend, friend_status, blacklisted_by_me, blacklisted, can_write_private_message, screen_name";
    /**
